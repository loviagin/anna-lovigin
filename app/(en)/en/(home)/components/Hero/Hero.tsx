...
const artworks: Artwork[] = [
  { id: 1, title: 'Work 1', imageUrl: '/artworks/1.webp' },
  { id: 2, title: 'Work 2', imageUrl: '/artworks/2.webp' },
  { id: 3, title: 'Work 3', imageUrl: '/artworks/3.webp' },
  { id: 4, title: 'Work 4', imageUrl: '/artworks/4.webp' },
  { id: 5, title: 'Work 5', imageUrl: '/artworks/5.webp' },
  { id: 6, title: 'Work 6', imageUrl: '/artworks/6.webp' },
  ...
  return (
    <section className={styles.hero}>
      <div className={styles.heroContent}>
        <h1 className={styles.title}>Anna Loviagina</h1>
        <p className={styles.slogan}>Professional artist</p>
        <div className={styles.buttons}>
          <Link href={'/#featured'} className={styles.primaryButton}>View works</Link>
